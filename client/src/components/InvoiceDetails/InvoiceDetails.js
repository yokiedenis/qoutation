              ...
              {invoice?.creator?.includes(user?.result._id) && (
                <Container style={{ marginBottom: "20px" }}>
                  ...
                  <Typography variant="subtitle2">
                    {invoice?.businessDetails?.data[0]?.businessName}
                  </Typography>
                  <Typography variant="body2">
                    {invoice?.businessDetails?.data[0]?.email}
                  </Typography>
                  <Typography variant="body2">
                    {invoice?.businessDetails?.data[0]?.phoneNumber}
                  </Typography>
                  <Typography variant="body2" gutterBottom>
                    {invoice?.businessDetails?.data[0]?.address}
                  </Typography>
                </Container>
              )}
              <Container>
              ...
              <Table className={classes.table} aria-label="simple table">
                ...
                <TableBody>
                  {invoiceData?.items?.map((itemField, index) => {
                    ...
                    const discount = parseFloat(itemField?.discount) || 0;
                    const amount =
                      quantity * unitPrice -
